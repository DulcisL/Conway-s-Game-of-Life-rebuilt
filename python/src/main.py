...
def main():
    ...
    try:
        ...
        MENU_Y = .9 * SCREEN_Y * SCALE_Y
        MENU_X = .8 * SCREEN_X * SCALE_X

        #Set the correct Scale for menus
        MENU_THEME.title_font_size= min(50, math.floor(100 * SCALE_X)) | max(50, math.floor(100 * SCALE_X))
        MENU_THEME.widget_font_size= min(25, math.floor(50 * SCALE_X)) | max(25, math.floor(100 * SCALE_X))
